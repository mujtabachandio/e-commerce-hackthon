...
const Navbar = () => {
  ...
  const linkClass = (path: string) =>  // Changed `any` to `string`
    pathname === path
  ...
  return (
    <nav className="relative">
      ...
      {/* Cart Sidebar */}
      <div
        className={`fixed top-0 right-0 h-full w-64 md:w-96 bg-white shadow-md transition-transform transform z-50 ${
        ...
        <div className="p-4">
          ...
          <div className="mt-4 z-50">
            ...
            <div className="mt-4 flex space-x-2">
              <Link href="/cart" className="flex-1 p-2 bg-black text-white text-center">
                View Cart
              </Link>
              <Link href="/checkout" className="flex-1 p-2 bg-black text-white text-center">
                Checkout
              </Link>
            </div>
          </div>
